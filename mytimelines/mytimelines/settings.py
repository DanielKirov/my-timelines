"""
Django settings for mytimelines project.
...
SECRET_KEY = '(cefvr90oinkzo@=4pfk(iqm&d_j2+dxm1d9755wvk&p6v4$yf'
...
WSGI_APPLICATION = 'mytimelines.wsgi.application'
